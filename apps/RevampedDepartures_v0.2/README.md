...
**This README covers the changes I've made available in this version. General functionality is mirrored to the latest official `MatrixBox/Departures` app, as available on 2026-09-06.**

## Seperation of 'skins' and app core

To be able to, in the future, make it possible to install or create custom skins more easily, the skin handling (i.e. lay-out loading, options, rendering etc.) has been seperated from the core functions of the app. All skins and their handling have moved to a `/skins` folder. Further parts have moved to `/skin_engine`. More info is listed in the `/docs` folder. This will be updated further in the future.
