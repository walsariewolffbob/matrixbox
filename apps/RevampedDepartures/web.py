...
def html():
    ...
    custom_scroll_html = ''.join([
        ...
        '<div id="custom-scroll-position-row" class="toggle-row" style="border-bottom:none;', _cs_pos_show, ';opacity:', (_scroll_custom_opacity if bool(_active_controls.get('scroll_position', False)) else "1"), '"><label for="custom_scroll_position" class="toggle-label">Position</label>',
        ...
        (_scroll_custom_disabled if bool(_active_controls.get('scroll_position', False)) else ""), '>',
