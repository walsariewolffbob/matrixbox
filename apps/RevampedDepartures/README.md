...
The biggest change in v0.2 is a new renderer/skin architecture.
...
**Installing third-party skins directly is not supported yet.** That is the next major step planned for the skin system.
...
This is useful for boxes primarily dedicated to Departures, where the normal long-press exit behaviour may not always be needed.
